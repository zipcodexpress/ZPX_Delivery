...
export function Shipping({ profile, audience, onAccount, onLogout }: {
  ...
  return <main className="shipping-page">
    ...
    <p className="development-banner">Development preview · Create shipments, simulate payment and print test labels. No real charges or physical drop-off. Authorize.net integration is next.</p>
